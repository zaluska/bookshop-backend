	...
	if(isset($_SESSION['user'])){
			...
			foreach($stmt as $row){
				...
				$output .= "
					<tr>
						...
						<td>kr ".number_format($subtotal, 2)."</td>
					</tr>
				";
			}
			$output .= "
				<tr>
					...
					<td><b>kr ".number_format($total, 2)."</b></td>
				<tr>
			";
		...
		if(count($_SESSION['cart']) != 0){
			...
			foreach($_SESSION['cart'] as $row){
				...
				$output .= "
					<tr>
						<td><button type='button' data-id='".$row['productid']."' class='btn btn-flat cart_delete'><i class='fas fa-trash-alt fa-2x'></i></button></td>
						<td><img src='".$image."' width='30px' height='30px'></td>
						<td>".$product['name']."</td>
						<td>kr ".number_format($product['price'], 2)."</td>
						<td class='input-group'>
							<span class='input-group-btn'>
